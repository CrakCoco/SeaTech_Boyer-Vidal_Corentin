...
void OperatingSystemLoop(void) {
    switch (stateRobot) {
        ...
        case STATE_TOURNE_EXGAUCHE:
            ...
            PWMSetSpeedConsigne(0, MOTEUR_GAUCHE);
            stateRobot = STATE_TOURNE_EXDROITE_EN_COURS;
            break;
...
void SetNextRobotStateInAutomaticMode() {
    ...
    //Détermination de la position des obstacles en fonction des télémtres
    if (robotState.distanceTelemetreCentre > 30 &&
            robotState.distanceTelemetreDroit > 20 &&
            robotState.distanceTelemetreEXDroite < 30) //Obstacle àgauche
